...
const firebaseConfig = {
  apiKey: "AIzaSyBSKT0knhfyLHSuz-Z8nnj3jrYn2KBcP0M",
...
export default function App() {
  ...
  try {
    ...
    setOtpSent(true); // এটি নিশ্চিত করবে যে ওটিপি বক্সটি স্ক্রিনে আসবে
  ...
  if(adminPass === 'sakib123') { 
    try {
      await fetchAllOrders(); // ডেটা আগে লোড হবে
      setViewMode('admin');   // তারপর ড্যাশবোর্ড দেখাবে
      setAdminPass(''); 
    } catch (err) {
      alert("অর্ডার লোড করতে সমস্যা হয়েছে!");
    }
  } else {
    alert('ভুল পাসওয়ার্ড!'); 
  }
